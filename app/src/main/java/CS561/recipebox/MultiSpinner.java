...
public class MultiSpinner extends AppCompatSpinner implements OnMultiChoiceClickListener, OnCancelListener {
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), com.androidbuts.multispinnerfilter.R.layout.textview_for_spinner, new String[]{spinnerText});
        setAdapter(adapter);
    ...
    public boolean performClick() {
        super.performClick();
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext(), com.androidbuts.multispinnerfilter.R.style.myDialog);
    ...
    public void setItems(LinkedHashMap<String, Boolean> items, MultiSpinnerListener listener) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), com.androidbuts.multispinnerfilter.R.layout.textview_for_spinner, new String[]{defaultText});
        setAdapter(adapter);
